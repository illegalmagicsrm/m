      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="hidden md:flex space-x-2">
            <button
              onClick={() => scroll('left')}
              className="bg-white/90 backdrop-blur-sm hover:bg-white text-gray-700 hover:text-purple-600 p-2 rounded-full shadow-lg transition-all duration-200 hover:scale-110"
            >
