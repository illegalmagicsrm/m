    ...
    <section className="py-8 bg-gradient-to-br from-green-50 via-white to-blue-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
          ...
          <button
            onClick={() => scroll('left')}
            className="hidden md:flex absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-white/90 backdrop-blur-sm hover:bg-white text-gray-700 hover:text-green-600 p-2 rounded-full shadow-lg transition-all duration-200 hover:scale-110"
          >
          ...
          <button
            ...
            className="hidden md:flex absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-white/90 backdrop-blur-sm hover:bg-white text-gray-700 hover:text-green-600 p-2 rounded-full shadow-lg transition-all duration-200 hover:scale-110"
          >
          ...
          <div
            ref={scrollRef}
            className="flex gap-3 md:gap-4 overflow-x-auto scrollbar-hide pb-2 px-2 md:px-12"
              ...
              >
                <div className={`bg-white rounded-2xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl w-24 md:w-32 ${
                  ...
                  <div className="p-2 md:p-3 text-center">
                    ...
                    <p className="text-xs text-gray-600">{category.productCount}</p>
                  </div>
                </div>
              </div>
            ))}
